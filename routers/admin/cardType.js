...
router.post("/", adminAuth, async (req, res) => {
  ...
  try {
    ...
    if (userType !== 'ADMIN' || (!permissions.includes("superadmin") && !permissions.includes("create_card_type"))) {
...
router.get("/", adminAuth, async (req, res) => {
  ...
  try {
    ...
    if (userType !== 'ADMIN' || (!permissions.includes("superadmin") && !permissions.includes("read_card_type"))) {
...
router.put("/:id", adminAuth, async (req, res) => {
  ...
  try {
    ...
    if (userType !== 'ADMIN' || (!permissions.includes("superadmin") && !permissions.includes("update_card_type"))) {
...
router.put("/active/:id", adminAuth, async (req, res) => {
  ...
  try {
    ...
    if (userType !== 'ADMIN' || (!permissions.includes("superadmin") && !permissions.includes("card_type_status"))) {
...
router.delete("/:id", adminAuth, async (req, res) => {
  ...
  try {
    ...
    if (userType !== 'ADMIN' || (!permissions.includes("superadmin") && !permissions.includes("delete_card_type"))) {
